  ...
  return (
    <section id="about" className="py-16 bg-gradient-to-b from-[#040024CC] to-[#0b0b22FD] text-white">
      <div className="container mx-auto px-6 lg:px-8 text-center">
        ...
        <a href='/booking' className="mt-12 py-3 px-8 bg-yellow-300 text-black font-semibold rounded-full hover:bg-yellow-400 transition duration-300 ease-in-out shadow-lg">
          Book Your Seat Now
        </a>
      </div>
    </section>
